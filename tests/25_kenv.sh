...
# - kenv_check_dump (uses ABAC_OP_READ against abac_kenv_object)
# - kenv_check_get (uses ABAC_OP_READ against abac_kenv_object)
# - kenv_check_set (uses ABAC_OP_WRITE against abac_kenv_object)
# - kenv_check_unset (uses ABAC_OP_WRITE against abac_kenv_object)
#
...
# ===========================================
# kenv_check_dump Tests (ABAC_OP_READ)
# ===========================================
...
"$MAC_ABAC_CTL" rule add "deny read * -> type=kenv" >/dev/null
if kenv >/dev/null 2>&1; then
...
"$MAC_ABAC_CTL" rule clear >/dev/null
"$MAC_ABAC_CTL" mode enforcing >/dev/null
"$MAC_ABAC_CTL" rule add "allow read * -> type=kenv" >/dev/null
...
# ===========================================
# kenv_check_get Tests (ABAC_OP_READ)
# ===========================================
echo ""
...
# ===========================================
# kenv_check_set Tests (ABAC_OP_WRITE)
# ===========================================
echo ""
...
"$MAC_ABAC_CTL" rule clear >/dev/null
"$MAC_ABAC_CTL" mode enforcing >/dev/null
"$MAC_ABAC_CTL" rule add "deny write * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow read * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow all * -> *" >/dev/null
...
"$MAC_ABAC_CTL" rule clear >/dev/null
"$MAC_ABAC_CTL" mode enforcing >/dev/null
"$MAC_ABAC_CTL" rule add "allow write * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow read * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow all * -> *" >/dev/null
...
# ===========================================
# kenv_check_unset Tests (ABAC_OP_WRITE)
# ===========================================
echo ""
...
"$MAC_ABAC_CTL" rule add "allow write type=admin -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "deny write * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow read * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow all * -> *" >/dev/null
...
"$MAC_ABAC_CTL" rule clear >/dev/null
"$MAC_ABAC_CTL" mode enforcing >/dev/null
"$MAC_ABAC_CTL" rule add "allow all * -> type=kenv" >/dev/null
"$MAC_ABAC_CTL" rule add "allow all * -> *" >/dev/null
...
"$MAC_ABAC_CTL" rule add "allow all * -> type=file" >/dev/null
